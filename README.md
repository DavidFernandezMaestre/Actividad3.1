# Actividad3.1
Ejercicios de HTML y CSS: David Fernández Maestre
...
Las citas se muestran una al lado de la otra formando una trama rectangular. Además, alhacer zoom o al estrechar o ensanchar la ventana, el número de citas por fila se ajusta automáticamente. Eso se puede conseguir con posicionamiento flotante.
...
A partir de aquí todos los ejercicios utilizarán etiquetas
semánticas de HTML, footer, nav y un favicon
